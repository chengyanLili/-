<template>
    <div class="candidateList">
        <div class="myMessages" v-for="(msg, index) in data.messageList" :key="index">
          <div class="msgBody">
            <div class="msg-icon">
                <el-image style="width: 100px; height: 100px" :src="msg.avatarUrl" fit="fill" />
            </div>
            <div class="msgContent">
                ...
                <div class="operate">
                    <el-button type="primary" @click="handleDetail(msg)">候选人详情</el-button>
                </div>
            </div>
          </div>
    ...
    <el-drawer v-model="drawer" :title="data.title">
        ...
        <li><el-tag class="ml-2" type="success" @click="handleVote">投票</el-tag></li>
      </ul>
    </el-drawer>
    </template>
...
const handleVote = () => {
    data.infos.votes += 1
    data.infos.birthday = data.messageList.birthday
