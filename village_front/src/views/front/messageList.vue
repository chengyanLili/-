<template>
  <div class="grid-item messages">
    <div class="title" style="margin-bottom: 20px">
      ...
      <el-button type="primary" style="margin-left: 20px" @click="sendMsg"
        >发信件</el-button
      >
      <el-radio-group
        v-model="data.radio"
      ...
      <div class="msgBody">
        <div class="msgContent">
          <div class="content-title">
            ...
            <el-button v-if="msg.reply" type="success" size="small"
              >已回复</el-button
            >
          ...
          <div class="cmessage-info">主题：{{ msg.theme }}</div>
        </div>
        <div class="msg-icon">
          <el-button
            type="danger"
...
const rules = reactive({
  ...
  content: [{ required: "true", message: "信件内容不能为空", trigger: "blur" }],
});
