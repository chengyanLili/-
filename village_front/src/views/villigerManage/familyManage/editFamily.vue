<template>
  ...
  <div class="grid">
      ...
      <div class="member">
        ...
        >
          <el-form-item label="成员" prop="relation">
            <el-select
              style="width: 194px"
              v-model="data.memberForm.relation"
              placeholder="与户主关系"
            >
              <el-option
                v-for="item in config.RELATION"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              />
          ...
          <el-form-item label="姓名" prop="memberName">
            <el-input
              v-model="data.memberForm.memberName"
              placeholder="请输入姓名"
            />
          </el-form-item>
          <el-form-item label="身份证号" prop="householdIdCard">
            <el-input
              v-model="data.memberForm.householdIdCard"
              placeholder="请输入身份证号"
            />
          </el-form-item>
    ...
    <div class="grid_right">
      <div class="table_title">户口关系表</div>
  ...
  >
    ...
    >
      ...
      <el-form-item label="成员" prop="relation" :label-width="formLabelWidth">
        <el-select
          style="width: 200px"
          v-model="data.editForm.relation"
          placeholder="与户主关系"
        >
          <el-option
            v-for="item in config.RELATION"
      ...
      >
        <el-input
          style="width: 200px"
          v-model="data.editForm.householdIdCard"
          placeholder="请输入身份证号"
        />
      </el-form-item>
      <el-form-item
...
function back() {
  router.push("/populationFile/familyList");
}
function reset() {
...
function load() {
  request
    .get(
      "/api/family/familyDetail?accountNo=" +
        router.currentRoute.value.query.accountNo
    )
    .then((res) => {
